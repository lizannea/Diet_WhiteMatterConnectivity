...
#SBATCH -e /fred/oz251/Mast/derivatives/LA/qsiprep/log/error_%x_%A_%a.log			# Standard error
#SBATCH -o /fred/oz251/Mast/derivatives/LA/qsiprep/log/output_%x_%A_%a.log			# Standard output
#
#####################################################################################################################################################################
#
#
...
#####################################################################################################################################################################
#
# Usage             : QSIPrep_sbatch_recon_MAST.sh
...
subj=$1
bids_root_dir="/fred/oz251/Mast/conversion_LA"
container_dir="/fred/oz251/containers/qsiprep-0.16.1.sif"
derivs_dir="/fred/oz251/Mast/derivatives/LA/qsiprep"
...
-B /fred/oz251 \
-B /fred/oz251/Mast:/data \
-B /fred/oz251/Mast/derivatives/LA/qsiprep/work:/work \
...
--recon_spec /fred/oz251/Mast/conversion_LA/code/LA/qsiprep/recon/mrtrix_5tt_rf.json `# json file specifying a reconstruction pipeline to be run after preprocessing -Matt`\
...
-w /work >& /fred/oz251/Mast/derivatives/LA/qsiprep/log/qsiprep_rec_${subj}_$(date -Iseconds).log
