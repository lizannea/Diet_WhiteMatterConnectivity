...
#SBATCH -o /fred/oz251/Mast/derivatives/LA/qsiprep/log/log/output_%x_%A_%a.log			# Standard output
...
#-----------------------------------------
#
# A batch script to pre-process the MAST dataset
#
################################################################################
#
...
-B /fred/oz251/Mast:/data `#b data directory`\
...
--verbose \
-w /data/derivatives/LA/qsiprep/work >& /fred/oz251/Mast/derivatives/LA/qsiprep/log/qsiprep_${subj}_$(date -Iseconds).log
