...
apptainer exec /dagg/public/neuro/neurodesk_20230111/neurocommand/local/containers/mrtrix3_3.0.3_20210917/mrtrix3_3.0.3_20210917.simg bash ${codedir}/mrtrix_sbatch_script_connectome.sh ${subj} |& tee /fred/oz251/Mast/derivatives/LA/mrtrix/log/mrtrix_$(date -Iseconds).log
#fetch_and_run.sh mrtrix3 3.0.3 20210917 ${codedir}/mrtrix_sbatch_script_connectome.sh ${subj} |& tee /fred/oz251/Mast/derivatives/LA/mrtrix/log/mrtrix_2_$(date -Iseconds).log
