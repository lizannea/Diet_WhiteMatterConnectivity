...
codedir='/fred/oz251/Mast/conversion_LA/code/LA/mrtrix'
logdir='/fred/oz251/Mast/derivatives/LA/mrtrix/log/'
...
sbatch ${codedir}/bash_fechandrun.sh ${subj_id} |& tee /fred/oz251/Mast/derivatives/LA/mrtrix/log/mrtrix_$(date -Iseconds).log
done
