...
#SBATCH -e /fred/oz251/Mast/derivatives/LA/fmriprep/log/error_%A_%a.log			# Standard error
#SBATCH -o /fred/oz251/Mast/derivatives/LA/fmriprep/log/output_%A_%a.log		# Standard output
...
derivs_dir="/fred/oz251/Mast/derivatives/LA/fmriprep"
...
-B /fred/oz251/Mast/conversion_LA:/data \
-B $derivs_dir:/output \
...
--verbose \
--write-graph \
-w /work >& /fred/oz251/Mast/derivatives/LA/fmriprep/log/fmriprep_${subj}_$(date -Iseconds).log
